...
export const WalletConnect = () => {
  ...
  if (selectedWallet && selectedWallet.isWalletConnected) {
    return <Connected selectedWallet={selectedWallet} clearSelectedWallet={() => setSelectedWallet(null)} />;
  }

  if (selectedWallet) {
    return <Connecting selectedWallet={selectedWallet} clearSelectedWallet={() => setSelectedWallet(null)} />;
  }
